<<<<<<< HEAD
# Generated by Django 5.0.4 on 2024-06-03 18:07
=======
# Generated by Django 5.0.4 on 2024-06-03 22:28
>>>>>>> feature/agendamento
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data', models.DateTimeField(auto_now_add=True)),
                ('medicamento', models.CharField(blank=True, max_length=2000, null=True)),
                ('observacoes_receita', models.CharField(blank=True, max_length=2000, null=True)),
                ('consulta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clientes.consulta')),
            ],
        ),
    ]
